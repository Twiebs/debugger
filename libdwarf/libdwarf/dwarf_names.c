...
/* Generated on May  3 2016  07:02:14 */
...
dwarf_get_AT_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_AT_addr_base:
        *s_out = "DW_AT_addr_base";
        return DW_DLV_OK;
    case DW_AT_ranges_base:
        *s_out = "DW_AT_ranges_base";
        return DW_DLV_OK;
    case DW_AT_dwo_id:
        *s_out = "DW_AT_dwo_id";
        return DW_DLV_OK;
...
dwarf_get_LLE_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_LLE_end_of_list_entry:
        *s_out = "DW_LLE_end_of_list_entry";
        return DW_DLV_OK;
    case DW_LLE_base_address_selection_entry:
        *s_out = "DW_LLE_base_address_selection_entry";
        return DW_DLV_OK;
    case DW_LLE_start_end_entry:
        *s_out = "DW_LLE_start_end_entry";
        return DW_DLV_OK;
    case DW_LLE_start_length_entry:
        *s_out = "DW_LLE_start_length_entry";
        return DW_DLV_OK;
    case DW_LLE_offset_pair_entry:
        *s_out = "DW_LLE_offset_pair_entry";
        return DW_DLV_OK;
    }
    return DW_DLV_NO_ENTRY;
}
...
dwarf_get_LNE_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_LNE_set_discriminator:
        *s_out = "DW_LNE_set_discriminator";
        return DW_DLV_OK;
    case DW_LNE_define_file_MD5:
        *s_out = "DW_LNE_define_file_MD5";
        return DW_DLV_OK;
...
dwarf_get_LNCT_name (unsigned int val,const char ** s_out)
{
    ...
    case DW_LNCT_subprogram_name:
        *s_out = "DW_LNCT_subprogram_name";
        return DW_DLV_OK;
    case DW_LNCT_decl_file:
        *s_out = "DW_LNCT_decl_file";
        return DW_DLV_OK;
    case DW_LNCT_decl_line:
        *s_out = "DW_LNCT_decl_line";
        return DW_DLV_OK;
    }
    return DW_DLV_NO_ENTRY;
}
