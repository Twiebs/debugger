...
enum Dwarf_LLE_e {
    DW_LLE_end_of_list_entry                 = 0x0000,
    DW_LLE_base_address_selection_entry      = 0x0001,
    DW_LLE_start_end_entry                   = 0x0002,
    DW_LLE_start_length_entry                = 0x0003,
    DW_LLE_offset_pair_entry                 = 0x0004
};
...
enum Dwarf_SECT_e {
    ...
    DW_SECT_MACINFO                          = 0x0007,
    DW_SECT_MACRO                            = 0x0008
};
...
enum Dwarf_LNCT_e {
    ...
    DW_LNCT_size                             = 0x0004,
    DW_LNCT_MD5                              = 0x0005,
    DW_LNCT_subprogram_name                  = 0x0006,
    DW_LNCT_decl_file                        = 0x0007,
    DW_LNCT_decl_line                        = 0x0008
};
